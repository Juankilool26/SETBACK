...
PALETTE=0 1 2 3 6 9 11 12 13 14 15 18 20 24 25 26
$(eval $(call IMG2SP, SET_FOLDER , src/sprites/))
$(eval $(call IMG2SP, SET_PALETTE_FW  , $(PALETTE)         ))
$(eval $(call IMG2SP, CONVERT , img/protagonista.png , 10, 10, protagonista_sp, protagonista_pal))
$(eval $(call IMG2SP, CONVERT , img/floor_ceiling.png , 30, 10, floor_ceiling_sp, floor_ceiling_pal))
$(eval $(call IMG2SP, CONVERT , img/walls.png , 10, 30, walls_sp, walls_pal))
$(eval $(call IMG2SP, CONVERT , img/tiles.png , 10, 10, tiles_sp, tiles_pal))
$(eval $(call IMG2SP, CONVERT , img/lineadepinxos.png , 100, 10, linea_pin_sp, linea_pin_pal))
$(eval $(call IMG2SP, CONVERT , img/delimitador.png , 80, 10, delimitador_sp, demitador_pal))
$(eval $(call IMG2SP, CONVERT , img/tierra.png , 30, 30, tierra_sp, tierra_pal))

#Conversion de imagenes del menu
$(eval $(call IMG2SP, SET_OUTPUT, bin))
$(eval $(call IMG2SP, SET_IMG_FORMAT  , screen))
$(eval $(call IMG2SP, CONVERT , img/sMenu.png ,0,0, screen_menu))
$(eval $(call IMG2SP, CONVERT , img/sCredits.png ,0,0, screen_credits))
$(eval $(call IMG2SP, CONVERT , img/sHistory.png ,0,0, screen_history))
$(eval $(call IMG2SP, CONVERT , img/sControls.png ,0,0, screen_controls))
$(eval $(call IMG2SP, CONVERT , img/sWin.png ,0,0, screen_win))
