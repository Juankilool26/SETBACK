...
Hexadecimal [16-Bits]
                             ...
                             29 
                             30 
                             31 ;; String del manu de pausa
   6747 50 41 55 53 45 00    32 linea_men_ini_0:: .asciz "PAUSE"
   674D 53 50 41 43 45 20    33 linea_men_ini_1:: .asciz "SPACE to continue"
        74 6F 20 63 6F 6E
        74 69 6E 75 65 00
   675F 20 20 45 20 20 20    34 linea_men_ini_2:: .asciz "  E   to exit"
        74 6F 20 65 78 69
        74 00
                             35 
                             36 
                             ...
                             39 
                             40 ;; Nada de input
                             41 ;; Funcion que llama al render init para setear el modo de video a 
                             42 ;; y crear la paleta de colores que se utilizaran en el juego
   676D                      43 man_menu_init::
   676D CD 0C 45      [17]   44     call sys_render_init                ;; Inicializamos el render
   6770 C9            [10]   45     ret
                             46 
                             47 
                             48 
                             ...
                             51 
                             52 
                             53 ;; Funcion para mostrar los menus y navegar por los mismos
                             54 ;; INPUT
                             55 ;;      0
                             56 ;; DESTROY
                             57 ;;      ALL
                             58 ;; RETURN
                             59 ;;      0
   6771                      60 man_menu_run::
                             61 
                             62     ;; MENU INICIAL
                             63     ;; Pintamos el menu inicial por pantalla
   6771 21 E3 41      [10]   64     ld      hl, #_screenmenu_z_end
   6774 CD C1 67      [17]   65     call    man_menu_draw_menu_change
                             66 
   6777                      67 _initial_menu:
   6777 CD 26 68      [17]   68     call cpct_scanKeyboard_f_asm        ;; Escaneamos el teclado y lo guardamos en el buffer
                             69 
                             70     ;; Pulsamos SPACE para saltar al menu de historia
   677A 21 05 80      [10]   71     ld      hl, #Key_Space
   677D CD 90 68      [17]   72     call    cpct_isKeyPressed_asm
   6780 20 1C         [12]   73     jr     nz, _draw_history
                             74 
                             75     ;; Pulsamos C para visualizar los creditos
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 57.
Hexadecimal [16-Bits]



   6782 21 07 40      [10]   76     ld      hl, #Key_C
   6785 CD 90 68      [17]   77     call    cpct_isKeyPressed_asm
   6788 28 ED         [12]   78     jr      z, _initial_menu
                             79 
                             80 
                             81     ;; MENU DE CREDITOS
                             82     ;; Pintamos por pantalla los creditos
   678A 21 CA 3E      [10]   83     ld      hl, #_screencredits_z_end
   678D CD C1 67      [17]   84     call    man_menu_draw_menu_change
   6790                      85 _credits_menu:
                             86 
   6790 CD 26 68      [17]   87     call cpct_scanKeyboard_f_asm        ;; Escaneamos el teclado y lo guardamos en el buffer
                             88     ;; Si se pulsa SPACE volvemos al menu inicial
   6793 21 05 80      [10]   89     ld      hl, #Key_Space
   6796 CD 90 68      [17]   90     call    cpct_isKeyPressed_asm
   6799 28 F5         [12]   91     jr      z, _credits_menu
   679B C3 71 67      [10]   92     jp      man_menu_run
                             93 
                             94 
                             95     ;; MENU DE HISTORIA
   679E                      96 _draw_history:
                             97     ;; Pintamos por pantalla la historia
   679E 21 62 39      [10]   98     ld      hl, #_screenhistory_z_end
   67A1 CD C1 67      [17]   99     call    man_menu_draw_menu_change
   67A4                     100 _history_menu:
                            101     
   67A4 CD 26 68      [17]  102     call cpct_scanKeyboard_f_asm        ;; Escaneamos el teclado y lo guardamos en el buffer
                            103     ;; Si se pulsa SPACE dibujamos el menu de controles
   67A7 21 05 80      [10]  104     ld      hl, #Key_Space
   67AA CD 90 68      [17]  105     call    cpct_isKeyPressed_asm
   67AD 28 F5         [12]  106     jr      z, _history_menu
                            107 
                            108 
                            109     ;; MENU DE CONTROLES
                            110     ;; Pintamos por pantalla los controles
   67AF 21 9D 33      [10]  111     ld      hl, #_screencontrols_z_end
   67B2 CD C1 67      [17]  112     call    man_menu_draw_menu_change
   67B5                     113 _controls_menu:
                            114 
   67B5 CD 26 68      [17]  115     call cpct_scanKeyboard_f_asm        ;; Escaneamos el teclado y lo guardamos en el buffer
   67B8 21 05 80      [10]  116     ld      hl, #Key_Space
   67BB CD 90 68      [17]  117     call    cpct_isKeyPressed_asm
   67BE 28 F5         [12]  118     jr      z, _controls_menu
                            119 
   67C0 C9            [10]  120     ret
                            121 
                            122 
                            ...
                            126 
                            127 
                            128 ;; Funcion para renderizar una seccion del menu (imagenes comprimidas)
                            129 ;; INPUT
                            130 ;;      HL: Array con los bytes de la imagen comprimida
...
Hexadecimal [16-Bits]
                            ...
                            133 ;; RETURN
                            134 ;;      0
   67C1                     135 man_menu_draw_menu_change::
   67C1 11 FF FF      [10]  136     ld      de, #0xFFFF
   67C4 CD 2B 72      [17]  137     call    cpct_zx7b_decrunch_s_asm
   67C7 C9            [10]  138     ret
                            139 
                            140 
                            141 
                            ...
                            145 
                            146 
                            147 ;; Funcion para mostrar el menu de pause y darle dos opciones al usuario
                            148 ;; INPUT
                            149 ;;      0
                            150 ;; DESTROY
                            151 ;;      ALL
                            152 ;; RETURN
                            153 ;;      A: Opcion pulsada por el usuario (0: Space, 1: E)
   67C8                     154 man_menu_pause_run::
                            155 
   67C8 CD 3A 42      [17]  156     call cpct_limpiarPantalla_asm                    ;; Limpiamos la pantalla del nivel primero
                            157 
                            158     ;; MOSTRAMOS LAS OPCIONES DE MENU
                            159     ;; Mostramos el titulo del menu
   67CB 21 0F 00      [10]  160     ld hl, #0x000F                              ;; Cargamos en hl el color de las letras
   67CE CD 20 73      [17]  161     call cpct_setDrawCharM0_asm                 ;; Llamamos setDraw para asignar el color que hay en hl
   67D1 FD 21 47 67   [14]  162     ld iy, #linea_men_ini_0                     ;; Cargamos en IY el valor en asci de la etiqueta linea men_ini_1               
                     001E   163     X = 30
                     0028   164     Y = 40
   67D5 21 5E C1      [10]  165     ld hl, #0xC000 + 64 * (Y/8)+2048*(Y&7)+X    ;; Calculos necesarios para decir en que parte de la pantalla
   67D8 CD E2 70      [17]  166     call cpct_drawStringM0_asm                  ;; se van a pintar la lineas de texto que queremos
                            167                              
                            168     ;; Mostramos la opcion de reiniciar nivel
   67DB 21 04 00      [10]  169     ld hl, #0x0004
   67DE CD 20 73      [17]  170     call cpct_setDrawCharM0_asm
   67E1 FD 21 4D 67   [14]  171     ld iy, #linea_men_ini_1
                     0005   172     X = 5
                     0078   173     Y = 120
   67E5 21 C5 C3      [10]  174     ld hl, #0xC000 + 64 * (Y/8)+2048*(Y&7)+X
   67E8 CD E2 70      [17]  175     call cpct_drawStringM0_asm
                            176 
                            177     ;; Mostramos la opcion de salir
   67EB 21 04 00      [10]  178     ld hl, #0x0004
   67EE CD 20 73      [17]  179     call cpct_setDrawCharM0_asm
   67F1 FD 21 5F 67   [14]  180     ld iy, #linea_men_ini_2
                     0005   181     X = 5
                     00A0   182     Y = 160
   67F5 21 05 C5      [10]  183     ld hl, #0xC000 + 64 * (Y/8)+2048*(Y&7)+X
   67F8 CD E2 70      [17]  184     call cpct_drawStringM0_asm
                            185 
...
Hexadecimal [16-Bits]
                            ...
                            186 
                            187     ;; HABILITAMOS LOS INPUTS DEL USUARIO
   67FB                     188 _pause_menu:
   67FB CD 26 68      [17]  189     call cpct_scanKeyboard_f_asm                ;; Escaneamos el teclado y lo guardamos en el buffer
                            190 
                            191     ;; Opcion para continuar el nivel
   67FE 21 05 80      [10]  192     ld      hl, #Key_Space
   6801 CD 90 68      [17]  193     call    cpct_isKeyPressed_asm
   6804 20 0B         [12]  194     jr     nz, _pause_option_Space
                            195 
                            196     ;; Opcion para salir y volver al menu inicial
   6806 21 07 04      [10]  197     ld      hl, #Key_E
   6809 CD 90 68      [17]  198     call    cpct_isKeyPressed_asm
   680C 28 ED         [12]  199     jr      z, _pause_menu
   680E 3E 01         [ 7]  200     ld      a, #1                               ;; Devolvemos la opcion Exit
   6810 C9            [10]  201     ret
                            202 
   6811                     203 _pause_option_Space:
   6811 3E 00         [ 7]  204     ld      a, #0                               ;; Devolvemos la opcion Continue
   6813 C9            [10]  205     ret
                            206 
                            207 
                            208 
                            ...
                            211 
                            212 
                            213 ;; Funcion para mostrar el menu de partida ganada
                            214 ;; INPUT
                            215 ;;      0
                            216 ;; DESTROY
                            217 ;;      ALL
                            218 ;; RETURN
                            219 ;;      0
   6814                     220 man_menu_win_run::
                            221 
                            222     ;; MENU FIN DE PARTIDA
                            223     ;; Pintamos por pantalla final
   6814 21 AA 2D      [10]  224     ld      hl, #_screenwin_z_end
   6817 CD C1 67      [17]  225     call    man_menu_draw_menu_change
   681A                     226 _win_menu:
                            227 
   681A CD 26 68      [17]  228     call cpct_scanKeyboard_f_asm        ;; Escaneamos el teclado y lo guardamos en el buffer
   681D 21 05 80      [10]  229     ld      hl, #Key_Space
   6820 CD 90 68      [17]  230     call    cpct_isKeyPressed_asm
   6823 28 F5         [12]  231     jr      z, _win_menu
   6825 C9            [10]  232     ret
