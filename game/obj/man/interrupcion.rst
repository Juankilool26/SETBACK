...
Hexadecimal [16-Bits]
                             ...
                             24 
                             25 
   6710 06                   26 velocidad_min_musica: .db 06
                             27 
                             28 ;; Funcion que controla paralela al bucle de game que se reproduzca la musica con una tasa 
                             29 ;; de 50Hz
   6711                      30 int_handler::
                             31 
                             32    ;; Conservamos todos los registros ya que la funcion cpct_akp_musicPlay_asm se carga literalmente
                             33    ;; todos ademas de los primos de cada registro
   6711 F5            [11]   34    push af
   6712 C5            [11]   35    push bc
   6713 D5            [11]   36    push de
   6714 E5            [11]   37    push hl
                             38 
   6715 3A 10 67      [13]   39    ld   a, (velocidad_min_musica)
   6718 3D            [ 4]   40    dec  a
   6719 20 05         [12]   41    jr  nz, _cont
   671B                      42 _zero:
   671B CD BB 68      [17]   43    call cpct_akp_musicPlay_asm
   671E 3E 06         [ 7]   44    ld   a, #6
   6720                      45 _cont:
   6720 32 10 67      [13]   46    ld    (velocidad_min_musica), a
                             47 
   6723 E1            [10]   48    pop hl
   6724 D1            [10]   49    pop de
   6725 C1            [10]   50    pop bc
   6726 F1            [10]   51    pop af
                             52 
   6727 FB            [ 4]   53    ei
   6728 ED 4D         [14]   54    reti
                             55 
                             56 ;; Interrupcion personalizada que se mete en la direccion de memoria a continuacion del #0x0038
   672A                      57 set_int_handler::
   672A 21 38 00      [10]   58    ld     hl, #0x38
   672D 36 C3         [10]   59    ld   (hl), #0xC3
   672F 23            [ 6]   60    inc    hl
   6730 36 11         [10]   61    ld   (hl), #<int_handler
   6732 23            [ 6]   62    inc    hl
   6733 36 67         [10]   63    ld   (hl), #>int_handler
   6735 23            [ 6]   64    inc    hl
   6736 36 C9         [10]   65    ld   (hl), #0xC9
   6738 C9            [10]   66    ret
                             67 
                             68 ;; Cargamos en DE la etiqueta correspondiente a la cancion de menu y la inicializamos
   6739                      69 man_int_load_menu_song::
                             70 
                             71    ;; INPUT: DE to the start of songdata array
   6739 11 40 00      [10]   72    ld de, #_song_menu
   673C CD C5 6F      [17]   73    call cpct_akp_musicInit_asm
                             74 
   673F C9            [10]   75    ret
                             76 ;; Cargamos en DE la etiqueta correspondiente a la cancion de ingame y la inicializamos
   6740                      77 man_int_load_ingame_song::
                             78 
...
Hexadecimal [16-Bits]
                             ...
                             79    ;; INPUT: DE to the start of songdata array
   6740 11 D2 01      [10]   80    ld de, #_song_ingame
   6743 CD C5 6F      [17]   81    call cpct_akp_musicInit_asm
                             82 
   6746 C9            [10]   83    ret
