...
Hexadecimal [16-Bits]
                             ...
                             30 
                             31 
                             32 ;; Definimos la paleta de colores
                             33 ;; PALETTE_FIRMWARE=0 1 2 3     6 9 11 12       13 15 16 18     20 24 25 26
                             34 ;palette:
                             35 ;    .db HW_BLACK        ,   HW_BLUE             ,   HW_BRIGHT_BLUE      ,   HW_RED
                             36 ;    .db HW_BRIGHT_RED   ,   HW_GREEN            ,   HW_SKY_BLUE         ,   HW_YELLOW
                             37 ;    .db HW_WHITE        ,   HW_ORANGE           ,   HW_PINK             ,   HW_BRIGHT_GREEN
                             38 ;    .db HW_BRIGHT_CYAN  ,   HW_BRIGHT_YELLOW    ,   HW_PASTEL_YELLOW    ,   HW_BRIGHT_WHITE
                             39 
                             40 
                             41 
                             42 
                             ...
                             44 
                             45 
                             46 ;; Inicializa el sistema de render
                             47 ;; INPUT
                             48 ;;      0
                             49 ;; DESTROY
                             50 ;;      C, HL, DE
                             51 ;; RETURN
                             52 ;;      0
   450C                      53 sys_render_init::
                             54 
                             55     ;; Cambia a MODE 0
   450C 0E 00         [ 7]   56     ld      c, #0
   450E CD 1E 72      [17]   57     call cpct_setVideoMode_asm
                             58 
                             59     ;; BORDER 13, SET PALETTE
   0005                      60     cpctm_setBorder_asm  HW_BLACK                  ; Macro de la libreria de CPCTelera
                              1    .radix h
   0005                       2    cpctm_setBorder_raw_asm \HW_BLACK ;; [28] Macro that does the job, but requires a number value to be passed
                              1    .globl cpct_setPALColour_asm
   4511 21 10 14      [10]    2    ld   hl, #0x1410         ;; [3]  H=Hardware value of desired colour, L=Border INK (16)
   4514 CD AF 68      [17]    3    call cpct_setPALColour_asm  ;; [25] Set Palette colour of the border
                              3    .radix d
   4517 21 72 28      [10]   61     ld      hl, #_protagonista_pal                 ; Cragamos la paleta del marcianito
   451A 11 10 00      [10]   62     ld      de, #16
   451D CD 9C 68      [17]   63     call    cpct_setPalette_asm
   4520 C9            [10]   64     ret
                             65 
                             66 
                             67 
                             ...
                             72 
                             73 
                             74 ;; Renderiza la entidad pasada por parametro con color de fondo
...
Hexadecimal [16-Bits]
                             ...
                             75 ;; INPUT
                             76 ;;      IY: Posicion de la entidad a renderizar
                             77 ;; DESTROY
                             78 ;;      AF, DE, BC, HL
                             79 ;; RETURN
                             80 ;;      0
   4521                      81 sys_render_update_one_entity_clear::
                             82 
   4521 FD 5E 0A      [19]   83     ld      e, e_lastPtr  (iy)      ; Cargamos en DE el puntero a la anterior instancia pintada
   4524 FD 56 0B      [19]   84     ld      d, e_lastPtr+1(iy)
   4527 3E 00         [ 7]   85     ld      a, #0x00                ; Cargamos en A el color de fondo
   4529 FD 4E 05      [19]   86     ld      c, e_w(iy)              ; Ancho/Width
   452C FD 46 06      [19]   87     ld      b, e_h(iy)              ; Alto/Height
   452F CD 7B 72      [17]   88     call cpct_drawSolidBox_asm
   4532 C9            [10]   89     ret
                             90 
                             91 
                             92 
                             ...
                             97 
                             98 
                             99 ;; Renderiza la entidad pasada por parametro
                            100 ;; INPUT
                            101 ;;      IY: Posicion de la entidad a renderizar
                            102 ;; DESTROY
                            103 ;;      AF, DE, BC, HL
                            104 ;; RETURN
                            105 ;;      0
   4533                     106 sys_render_update_one_entity::
                            107 
                            108 
                            109     ;; Comprobamos si la entidad es una estrella de fondo
   4533 FD 7E 00      [19]  110     ld      a, e_type(iy)                                   ; A = e_type
   4536 EE 39         [ 7]  111     xor     #(e_type_render_mask | e_type_star)             ; Estrella renderizada renderizada
   4538 20 0E         [12]  112     jr     nz, _render_update_entity                       ; Si = 0 no es una plataforma
                            113 
                            114     ;; ESTRELLA DETECTADA
   453A FD 7E 0E      [19]  115     ld      a, e_distance(iy)
   453D 3D            [ 4]  116     dec     a
   453E 20 05         [12]  117     jr     nz, _render_mark_star
   4540 FD 35 0E      [23]  118     dec     e_distance(iy)
   4543 18 31         [12]  119     jr      _stop_render_entity
   4545                     120 _render_mark_star:
   4545 FD 34 0E      [23]  121     inc     e_distance(iy)
                            122 
                            123     
   4548                     124 _render_update_entity:
                            125 
                            126     ;; Eliminamos la instacia previa con el color de fondo
   4548 CD 21 45      [17]  127     call    sys_render_update_one_entity_clear
                            128 
                            129 
...
Hexadecimal [16-Bits]
                            ...
                            130     ;; Obtenemos el HL el puntero a la posicion de memoria a pintar
   454B 11 00 C0      [10]  131     ld     de, #screen_start                                ; Cargamos en DE la posicion inicial de la pantalla
   454E FD 4E 01      [19]  132     ld      c, e_x(iy)                                      ; X
   4551 FD 46 02      [19]  133     ld      b, e_y(iy)                                      ; Y
   4554 CD 43 73      [17]  134     call cpct_getScreenPtr_asm                              ; Calculate video memory location and return it in HL
                            135     
                            136 
                            137     ;; Dibujamos la nueva posicion
   4557 EB            [ 4]  138     ex     de, hl
   4558 FD 6E 07      [19]  139     ld      l, e_sp_l(iy)
   455B FD 66 08      [19]  140     ld      h, e_sp_h(iy)
   455E FD 4E 05      [19]  141     ld      c, e_w(iy)                                      ; Ancho/Width
   4561 FD 46 06      [19]  142     ld      b, e_h(iy)                                      ; Alto/Height
   4564 CD 6C 71      [17]  143     call cpct_drawSprite_asm                                ; Rutina de cpctelera que realiza 3 push y 1 pop
                            144 
                            145 
                            146     ;; Comprobamos si es una plataforma y dejamos de pintarla
   4567                     147 _render_check_platform:
   4567 FD 7E 00      [19]  148     ld      a, e_type(iy)                                   ; A = e_type
   456A EE 38         [ 7]  149     xor     #(e_type_render_mask | e_type_platform)         ; Plataforma renderizada
   456C 20 08         [12]  150     jr     nz, _stop_render_entity                          ; Si = 0 no es una plataforma
                            151 
                            152     ;; PLATAFORMA DETECTADA
   456E FD 7E 00      [19]  153     ld      a, e_type(iy)
   4571 EE 20         [ 7]  154     xor     #e_type_render_mask                             ; Quitamos su capacidad de renderizado
   4573 FD 77 00      [19]  155     ld      e_type(iy), a
                            156 
   4576                     157 _stop_render_entity:
   4576 C9            [10]  158     ret
                            159 
                            160 
                            161 
                            ...
                            167 
                            168 
                            169 ;; Renderiza todas las entidades
                            170 ;; INPUT
                            171 ;;      0
                            172 ;; DESTROY
                            173 ;;      AF, BC, HL, IX, IY
                            174 ;; RETURN
                            175 ;;      IX: Puntero a primera entidad libre del array
   4577                     176 sys_render_update_all::
   4577 21 33 45      [10]  177     ld      hl, #sys_render_update_one_entity                   ; Guardamos en IY un puntero a la rutina
   457A CD 4D 48      [17]  178     call    man_entity_update_forall                            ; Renderizamos todas las entidades
   457D C9            [10]  179     ret
                            180 
                            181 
                            182 
...
Hexadecimal [16-Bits]
                            ...
                            186 
                            187 
                            188 ;; Renderiza solo las entidades que se superponen (plataformas y jugador)
                            189 ;; INPUT
                            190 ;;      0
                            191 ;; DESTROY
                            192 ;;      AF, BC, HL, IX, IY
                            193 ;; RETURN
                            194 ;;      IX: Puntero a primera entidad libre del array
   457E                     195 sys_render_update::
                            196 
                            197     ;; Renderizamos todas las entidades de ambiente
   457E 21 33 45      [10]  198     ld      hl, #sys_render_update_one_entity                   ; Guardamos en IY un puntero a la rutina
   4581 3E 01         [ 7]  199     ld       a, #1                                              ; Actualizamos la colision con las estrellas
   4583 CD 63 48      [17]  200     call    man_entity_update_forall_matching                   ; Llamamos a la funcion de actualizar
                            201 
                            202     ;; Renderizamos al player
   4586 3E 00         [ 7]  203     ld      a, #0
   4588 CD 09 48      [17]  204     call    man_entity_get_from_idx_IY
   458B CD 33 45      [17]  205     call    sys_render_update_one_entity
                            206 
                            207     ;; Renderizamos todas las entidades de interaccion
   458E 21 33 45      [10]  208     ld      hl, #sys_render_update_one_entity                   ; Guardamos en IY un puntero a la rutina
   4591 3E 20         [ 7]  209     ld       a, #e_type_render_mask                             ; Actualizamos la colision con las plataformas
   4593 CD 63 48      [17]  210     call    man_entity_update_forall_matching                   ; Llamamos a la funcion de actualizar
   4596 C9            [10]  211     ret
                            212 
                            213 
                            214 
                            ...
                            218 
                            219 
                            220 ;; Borra el player y las entidades muertas (enemigos)
                            221 ;; INPUT
                            222 ;;      0
                            223 ;; DESTROY
                            224 ;;      AF, BC, HL, IX, IY
                            225 ;; RETURN
                            226 ;;      IX: Puntero a primera entidad libre del array
   4597                     227 sys_render_update_clear::
                            228 
                            229     ;; Borramos al enemigo
   4597 3E 00         [ 7]  230     ld      a, #0
   4599 CD 09 48      [17]  231     call    man_entity_get_from_idx_IY
   459C CD 21 45      [17]  232     call    sys_render_update_one_entity_clear
                            233 
                            234     ;; Borramos las entidades muertas
   459F 21 21 45      [10]  235     ld      hl, #sys_render_update_one_entity_clear             ; Guardamos en IY un puntero a la rutina
   45A2 3E 04         [ 7]  236     ld       a, #e_type_dead_mask                             ; Actualizamos la colision con las plataformas
   45A4 CD 63 48      [17]  237     call    man_entity_update_forall_matching                   ; Llamamos a la funcion de actualizar
   45A7 C9            [10]  238     ret
