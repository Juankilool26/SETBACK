...
Hexadecimal [16-Bits]
                             ...
                             23 .include "cpctelera_functions.h.s"
                              1 ;; This file is part of SETBACK.
                              2 ;; Copyright (C) 2020 TCore (@TCore14)
                              3 ;;
                              4 ;; This program is free software: you can redistribute it and/or modify
...
Hexadecimal [16-Bits]
                             ...
                             30 
                             31 
                             32 ;; Inicializa el sistema de input
                             33 ;sys_input_init::
                             34 ;    ret
                             35 
                             36 
                             ...
                             38 
                             39 
                             40 ;; Actualiza el sistema de input
                             41 ;; INPUTS
                             42 ;;      IX: Puntero a la entidad del player
                             43 ;; DESTROYS
                             44 ;;      A, D, BC, HL
                             45 ;; RETURN
                             46 ;;      0
   4422                      47 sys_input_update::
                             48 
                             49     ;; Resetea las velocidades
   4422 DD 36 03 00   [19]   50     ld      e_vx(ix), #0
                             51 
                             52 
                             53     ;; Escanea el teclado
   4426 CD 26 68      [17]   54     call cpct_scanKeyboard_f_asm    ; Guarda la informacion en un buffer y es un poco mas rapida que la funcion normal
                             55 
                             56 
                             57     ;; MOVIMIENTO A LA IZQUIERDA
                             58     ;; Comprobamos si las teclas estan pulsadas
   4429 21 04 04      [10]   59     ld      hl, #Key_O              ; Carga el codigo de la tecla O
   442C CD 90 68      [17]   60     call cpct_isKeyPressed_asm      ; Devuelve 0 si no esta pulsada y 1 si lo esta
   442F 28 08         [12]   61     jr      z, O_NotPressed
   4431                      62 O_Pressed:
   4431 DD 36 03 FF   [19]   63     ld      e_vx(ix), #-1           ; Velocidad negativa
   4435 DD 36 0C FF   [19]   64     ld      e_state(ix), #-1        ; El estado del jugador es mirando hacia la izquierda
   4439                      65 O_NotPressed:
                             66 
   4439 21 09 04      [10]   67     ld      hl, #Joy0_Left            ; Carga el codigo de la tecla A
   443C CD 90 68      [17]   68     call cpct_isKeyPressed_asm      ; Devuelve 0 si no esta pulsada y 1 si lo esta
   443F 28 08         [12]   69     jr      z, Joy0_Left_NotPressed
   4441                      70 Joy0_Left_Pressed:
   4441 DD 36 03 FF   [19]   71     ld      e_vx(ix), #-1           ; Velocidad negativa
   4445 DD 36 0C FF   [19]   72     ld      e_state(ix), #-1        ; El estado del jugador es mirando hacia la izquierda
   4449                      73 Joy0_Left_NotPressed:
                             74 
                             75 
                             76     ;; MOVIMIENTO A LA DERECHA
   4449 21 03 08      [10]   77     ld      hl, #Key_P              ; Carga el codigo de la tecla P
   444C CD 90 68      [17]   78     call cpct_isKeyPressed_asm      ; Devuelve 0 si no esta pulsada y 1 si lo esta
   444F 28 08         [12]   79     jr      z, P_NotPressed
...
Hexadecimal [16-Bits]
   ...
   4451                      80 P_Pressed:
   4451 DD 36 03 01   [19]   81     ld      e_vx(ix), #1            ; Velocidad negativa
   4455 DD 36 0C 01   [19]   82     ld      e_state(ix), #1         ; El estado del jugador es mirando hacia la derecha
   4459                      83 P_NotPressed:
                             84 
   4459 21 09 08      [10]   85     ld      hl, #Joy0_Right         ; Carga el codigo de la tecla D
   445C CD 90 68      [17]   86     call cpct_isKeyPressed_asm      ; Devuelve 0 si no esta pulsada y 1 si lo esta
   445F 28 08         [12]   87     jr      z, Joy0_Right_NotPressed
   4461                      88 Joy0_Right_Pressed:
   4461 DD 36 03 01   [19]   89     ld      e_vx(ix), #1            ; Velocidad negativa
   4465 DD 36 0C 01   [19]   90     ld      e_state(ix), #1         ; El estado del jugador es mirando hacia la derecha
   4469                      91 Joy0_Right_NotPressed:
                             92 
                             93 
                             94     ;; MOVIMIENTO HACIA ARRIBA
   4469 DD 35 09      [23]   95     dec     e_jump(ix)              ; Decrementamos el bool del salto
   446C C0            [11]   96     ret    nz                       ; if e_jump = 0 puede saltar
                             97 
   446D 21 08 08      [10]   98     ld      hl, #Key_Q              ; Carga el codigo de la tecla Q
   4470 CD 90 68      [17]   99     call cpct_isKeyPressed_asm      ; Devuelve 0 si no esta pulsada y 1 si lo esta
   4473 28 04         [12]  100     jr      z, Q_NotPressed
   4475                     101 Q_Pressed:
   4475 DD 36 04 F7   [19]  102     ld      e_vy(ix), #gravity_acc  ; Velocidad negativa
   4479                     103 Q_NotPressed:
                            104 
   4479 21 09 10      [10]  105     ld      hl, #Joy0_Fire1         ; Carga el codigo de la tecla Fire1
   447C CD 90 68      [17]  106     call cpct_isKeyPressed_asm      ; Devuelve 0 si no esta pulsada y 1 si lo esta
   447F 28 04         [12]  107     jr      z, Joy0_Fire1_NotPressed
   4481                     108 Joy0_Fire1_Pressed:
   4481 DD 36 04 F7   [19]  109     ld      e_vy(ix), #gravity_acc  ; Velocidad negativa
   4485                     110 Joy0_Fire1_NotPressed:
                            111 
   4485 C9            [10]  112     ret
